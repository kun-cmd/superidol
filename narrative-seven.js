/* Authored three second posts. Resolve is pure. Only recordPlay writes history. */
(() => {
  ...
  const posts = [
    {
      ...
      fan: {
        ...
        stance: row('M1P','我也笑了，别全算进去。','I laughed too. That is not everything.','我也笑了。但拿这三秒说他一直不会跳，就有点省事了。','I laughed too. Deciding he could never dance from three seconds is pretty convenient.'),
        spread: row('M1R','转三秒的时候带上原片。','Share the original with the clip.','转那三秒的时候，把原片也带上吧。愿意看的人不用再到处找。','Share the original with those three seconds. People who want to watch should not have to hunt for it.')
      },
      anti: {
        ...
        spread: row('B1R','三秒版舞蹈鉴赏。','Three seconds of dance criticism.','三秒版舞蹈鉴赏。不懂技术的也能看懂哪里好笑。','Three seconds of dance criticism. No training needed to spot the funny part.')
      }
    },
    {
      star: {
      ...
      fan: {
        ...
        stance: row('M2P','笑视频，别装懂他整个人。','Laugh at the clip. You do not know him.','觉得好笑是一回事。看三秒就敢替他这些年下结论，你倒是真省事。','Finding it funny is one thing. Three seconds and you can judge his whole career. Convenient.'),
    ...
    },
    {
      ...
      fan: {
        fact: row('M3E','原片留着，谁想看就看。','The original stays here.','原片留在这里，日期也留着。以后谁想知道这三秒是哪来的，能找得到。','The original stays here with the date. Anyone who wants to know where the clip came from can find it.',true),
        stance: row('M3P','我喜欢他，也看得出失误。','I like him. I can see bad moves.','我喜欢他，又不是没见过这段。倒是拿三秒显得自己特别清醒的人，挺把自己当回事。','I like him. I have seen the clip. Acting clever because you watched three seconds is quite an ego trip.'),
      ...
      anti: {
        ...
        spread: row('B3R','下次夸实力，想想这三秒。','Remember this when they say talent.','下次又有人说实力不用多说，就把这三秒放上去。确实不用多说了。','Next time someone says his talent speaks for itself, post these three seconds. It really does.')
      }
    }
  ];
  ...
  const combos = [
    {
      ...
      fan: [row('MP1','看得出失误，不等于不会跳。','A bad move is not a whole career.','那几下没跳好我看得出来，但你是把后面七年都看完了，才敢说他一直不会跳？','I can see the bad moves, but did you watch all seven years before deciding he could never dance?'),row('MR1','原片和日期都给你。','Here are the clip and date.','原片和日期都给你。看完可以不喜欢，别连是哪年的都懒得看。','Here are the original and date. You can dislike it. At least check what year it was.',true),row('ML1','三秒有失误，七年别一起删。','Bad moves, not seven missing years.','那几下确实好笑，原片也在这里。但他后面七年，不是你剪掉就不存在了。','Those moves are funny. The original is here too. Cropping out the next seven years does not erase them.',true)],
    ...
    {
      star: [row('HP2','回应归回应，舞台另看。','A response is not a performance.','我可以认当年没跳好，但现在也只配那三秒，这句话我不接。','I can own the bad moves back then, but I will not accept being worth only those three seconds now.'),row('HR2','把我说的话留完整。','Keep the whole sentence.','以前没跳好的我认，现在怎么样另看。这两句是一起的，别替我选。','I own what I did badly then. Judge the present separately. Those sentences go together. Do not choose for me.'),row('HL2','旧视频和现在，分开看。','Look at then and now separately.','旧视频是我拍的，解释也是我给的。我能说清楚的说清楚，舞台上的事留在舞台看。','I made the old video. I can give my own explanation. What I do on stage can be judged on stage.')],
      fan: [row('MP2','看懂年份很难吗？','Is reading the date that hard?','看懂年份很难吗，还是你就想拿这段说他不行，什么背景都嫌碍事？','Is reading the date that hard, or do you just want this to prove he is bad with context getting in the way?'),row('MR2','原片在这，别装找不到。','The original is here. No excuses.','原片在这，日期也在。再拿试镜当现在的舞台，是真看不懂还是装的？','The original and date are here. If an audition is still a current performance to you, are you confused or pretending?',true),row('ML2','看完再骂，别光挑省事的。','Watch it before judging.','视频可以笑，原片也在这。看三秒就装成什么都懂，倒是比看完整版省事。','Laugh at the video. The original is here. Acting like an expert after three seconds is easier than watching it.',true)],
    ...
    },
    {
      ...
      fan: [row('MP3','你不是清醒，是嫌看全太累。','Not insightful. Just too lazy to watch.','拿三秒当全部还觉得自己特别清醒，你只是嫌看全太累，别给自己加戏。','Three seconds for the whole story and you think that makes you insightful, you just cannot be bothered to watch.'),row('MR3','原片给了，脑子自己带。','The clip is here. Bring a brain.','原片给了，日期也给了。脑子得自己带，这个我真帮不了。','The original and date are here. Bring your own brain. I really cannot help with that.',true),row('ML3','喜欢他，也比复读三秒强。','Liking him beats repeating three seconds.','我喜欢他，也看得出失误。比起拿三秒复读一辈子，还觉得自己很幽默的人，我没什么不好意思的。','I like him and I can see mistakes. I am not embarrassed next to people repeating three seconds forever and calling it comedy.')],
      anti: [row('BP3','水平没看见，脾气先上来了。','No talent in sight. Plenty of attitude.','水平没看见脾气先上来了，舞跳成这样还这么要面子，粉丝真挺辛苦。','No talent in sight but plenty of attitude, dancing like that with an ego this big must be exhausting for his fans.'),row('BR3','删掉名字，还剩什么水平？','Take off the name. What talent remains?','把名字和舞台服都拿掉，再看这几个动作。还觉得是实力派，那你要求真挺低。','Take away the name and stage outfit. Watch those moves again. If that is talent, your standards are low.'),row('BL3','三秒够记住这个水平。','Three seconds to remember the standard.','原片旧，日期早，粉丝很喜欢。都记下了。可我提起他的舞蹈，还是先想起这三秒。','Old clip, early date, devoted fans. All noted. When I think of his dancing, these three seconds still come first.')]
    }
  ];
  const variants = {
    ...
    late: row('fullclip-late','原片给过了，脑子自己带。','The clip is here. Bring a brain.','原片和日期都给过了。还拿那三秒当全部，脑子是只够装三秒吗？','You already got the original and date. Still taking three seconds for everything. Is that all your brain can hold?',true),
  ...
  const support = [
    ...
    row('MS3','以后怎么跳，让Haru自己来。','Let Haru do the dancing from here.','旧视频留着，以后怎么跳让Haru自己来。别拿三秒替他跳完一辈子。','Keep the old video. Let Haru dance from here. Three seconds cannot perform the rest of his life for him.')
  ];
  ...
  function quoteRow(src,c) {
    ...
    if(raw.includes('给我留点别的代表作')) return row('quote-work','新代表作能超过三秒版吗？','Can the new work beat three seconds?','新代表作什么时候能超过三秒版？','When will the new work beat the three second version?');
    ...
    if(raw.includes('我也笑了') && src.role==='fan') return row('quote-fan-laugh','原来大家笑的是同一段。','We laughed at the same bit.','原来大家笑的是同一段。至少这三秒没冤枉剪辑。','We laughed at the same bit. At least these three seconds did the edit justice.');
    ...
    if(src.role==='star' && /笑|没跳好/.test(raw)) return row('quote-self-laugh','连本人都看笑了。','Even he laughed at it.','这三秒连本人都看笑了。','Even he laughed at these three seconds.');
