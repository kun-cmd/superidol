...
const EVENT_THEMES = {
  sevenSecondServe: { eyebrow: "OLD CLIP / NEW MEME", title: "The Three-Second Serve", copy: "Three seconds from an old audition are spreading. Haru, Maya and Ben each have something they refuse to let go.", fragmentTitle: "Afterimage", issues: [
    { title: "The clip resurfaces", claims: { star: "I danced badly at seventeen. That was seven years ago.", fan: "Three seconds do not tell you how he always dances.", anti: "The date does not make those moves any better." }, bystander: "Show the uncut clip before telling us what it proves." },
